...
public class MeldingHeropenenActivity extends AppCompatActivity {
    // logging
    private static final String TAG = "MeldingHeropenen";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melding_heropenen);
    ...
    private void initButtons(MeldingInfo meldingInfo) {
        ...
        buttonMeldingAnnuleren.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MeldingHeropenenActivity.this, MeldingDetailsMelderActivity.class);
        ...
        buttonMeldingHeropenen.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                try {
                    ...
                    // Heropen de melding.
                    meldingBeheerViewModel.heropenMelding(meldingInfo.getUidMelding(), inhoud);

                    // Verwijder observers.
                    removeObservers();

                    // Start activity overzicht meldingen melder.
                    Intent intent = new Intent(MeldingHeropenenActivity.this, OverzichtMeldingenMelderActivity.class);
                    intent.putExtra("melding_groep", meldingGroep);
                    startActivity(intent);
                    finish();
                }
                catch (MeldAppException e) {
                    Toast.makeText(MeldingHeropenenActivity.this, ExceptionVertaler.vertaalException(e.getMessage()), Toast.LENGTH_SHORT).show();
                }
            }
        });

        // Definieer de setting van de knop heropenen. Deze kan alsnog gedisabled worden als de status van deze
        ...
        switch (meldingInfo.getStatus()) {
            ...
            case INBEHANDELING:
            case GESLOTEN:
                buttonMeldingHeropenen.setEnabled(false);
                break;
            case OPGELOST:
                buttonMeldingHeropenen.setEnabled(true);
                break;
            default:
                buttonMeldingHeropenen.setEnabled(false);
                break;
    ...
    /**
     * Toont pop up scherm voor het sluiten van de melding.
     */
